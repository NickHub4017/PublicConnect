...
abc={"a": {"sysname": "control1",
           ...
           "inpdeamon": {"ip": "127.0.0.1", "type": "server", "port": 8050, "protocol": "tcp", "name": "inpdeamon"}, "programproperties": "-p 100 -q 1000",
           "next": {"ip": "192.168.1.4", "type": "client", "port": 8888, "protocol": "tcp", "name": "cntrldeamon"}, "deviceproperties": "-p 1500 -q 150"},
     "c": {"sysname": "control1",
           "cntrldeamon": {"ip": "127.0.0.1", "type": "client", "port": 8080, "protocol": "tcp", "name": "cntrldeamon"}, "timestamp": "2016-10-07", "fromip": "127.0.0.1",
           "oupdeamon": {"ip": "192.168.1.3", "type": "client", "port": 8100, "protocol": "tcp", "name": "oudeamon"}, "sysid": 1500,
           "inpdeamon": {"ip": "192.168.1.1", "type": "server", "port": 8100, "protocol": "tcp", "name": "inpdeamon"}, "programproperties": "-p 100 -q 1000",
           "next": {"ip": "192.168.1.3", "type": "client", "port": 8888, "protocol": "tcp", "name": "cntrldeamon"}, "deviceproperties": "-p 1500 -q 150"},
     "b": {"sysname": "control1",
           "cntrldeamon": {"ip": "127.0.0.1", "type": "client", "port": 8080, "protocol": "tcp", "name": "cntrldeamon"}, "timestamp": "2016-10-07", "fromip": "127.0.0.1",
           "oupdeamon": {"ip": "192.168.1.6", "type": "client", "port": 8100, "protocol": "tcp", "name": "oudeamon"}, "sysid": 1500,
           "inpdeamon": {"ip": "192.168.1.1", "type": "server", "port": 8100, "protocol": "tcp", "name": "inpdeamon"}, "programproperties": "-p 100 -q 1000",
           "next": {"ip": "192.168.1.6", "type": "client", "port": 8888, "protocol": "tcp", "name": "cntrldeamon"}, "deviceproperties": "-p 1500 -q 150"}}
...
acb={"a": {"sysname": "control1",
     ...
     "b": {"sysname": "control1",
           ...
           "oupdeamon": {"ip": "192.168.1.3", "type": "client", "port": 8100, "protocol": "tcp", "name": "oudeamon"}, "sysid": 1500,
           "inpdeamon": {"ip": "192.168.1.1", "type": "server", "port": 8100, "protocol": "tcp", "name": "inpdeamon"}, "programproperties": "-p 100 -q 1000",
           "next": {"ip": "192.168.1.10", "type": "client", "port": 8888, "protocol": "tcp", "name": "cntrldeamon"}, "deviceproperties": "-p 1500 -q 150"}}
